...
const DepositManage = () => {
  ...
  let hasPermission = checkPermission(permissionDetails, "uplineDepositManage");
  ...
  return (
    ...
    {["all", "approved"].map((tab) => (
      ...
      <div className="">
        ...
        {allDeposit.length>0&&<table className="w-full border-collapse">
          <thead>
            <tr  style={{backgroundColor:bg, color:"white"}} className="text-left border border-gray-300">
              <th className="p-2 border border-gray-300 min-w-[100px] text-[12px] font-bold">
                {t(`Trx`)}
              </th>
              <th className="p-2 border border-gray-300 min-w-[120px] text-[12px] font-bold">
                {t(`Gateway`)}/{t(`Method`)}
              </th>
              <th className="p-2 border border-gray-300 min-w-[110px] text-[12px] font-bold">
                {t(`Initiated`)}
              </th>
              <th className="p-2 border border-gray-300 min-w-[130px] text-[12px] font-bold">
                {t(`User`)}/{t(`UserId`)}
              </th>
              <th className="p-2 border border-gray-300 min-w-[100px] text-[12px] font-bold">
                {t(`Deposit`)} {t(`Amount`)}
              ...
              {check && (
                <th className="p-2 border border-gray-300 text-[12px] font-bold text-left">
                  {t(`Action`)}
                </th>
              )}
            </tr>
          ...
          <tbody>
            {allDeposit && !loading && allDeposit.length > 0 ? (
              allDeposit.map((item) => {
                ...
                return (
                  <tr
                    key={item._id}
                    className="text-left font-semibold h-[60px] border border-gray-300 hover:bg-gray-100"
                  >
                    ...
                    <td className="p-2 border border-gray-300">
                      <div className="flex items-center">
                        <Badge style={{ padding: '2px', fontSize: '10px' }}>
                          {item.method}
                        </Badge>
                      </div>
                    </td>
                    ...
                    <td className="p-2 border border-gray-300">
                      <div className="flex flex-col">
                        <p className="text-[16px]">
                          ...
                          <span className="text-xs text-red-500">{item.bonus}</span>
                        </p>
                        <p className="text-xs">
                          {(item.deposit_amount + item.bonus)?.toFixed(1)}{' '}
                          {item.currency}
                        </p>
                      </div>
                    </td>
                    ...
                    <td className="p-2 border border-gray-300">
                      <button
                        className={`px-2 py-1 rounded-md w-[100px] text-white text-[10px] ${

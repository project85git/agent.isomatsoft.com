...
const MoreGames = () => {
  ...
  const { color, primaryBg, iconColor, bg, border, secondaryBg } = useSelector(
    (state) => state.theme
  );
  ...
  return (
    <div>
      <div className="flex flex-col  gap-3  md:flex-row justify-between items-center pr-5">
      ...
      <div className="max-w-full mt-5  overflow-x-auto">
        ...
        <table className="min-w-full bg-white shadow-md rounded mb-4">
          <thead>
            ...
            <th className=""> <div className="px-4 py-3 text-left pl-[1rem] flex-nowrap w-[80px] border-gray-300">
            {t('Sl No')}
            </div>
            </th>
          ...
          <tbody>
            {game.length > 0 &&
             ...
             {check&& <td  className="pl-[14px] text-left w-[100px]">
                <Checkbox

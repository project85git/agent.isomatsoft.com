...
const AllAdmin = () => {
  ...
  let hasPermission1=checkPermission(permissionDetails,"allAdminManage")
  ...
  */}
    ...
    <tr className="bg-gray-100 border-b text-white" style={{ backgroundColor: bg, color: "white" }} >
      ...
      <th className="p-2 text-left text-xs font-semibold ">Profit & Loss</th>
            ...
            {check1 && (
              <div className="flex gap-1">
                ...
                <Link
                  ...
                  style={{ border: `1px solid ${border}60`, backgroundColor: primaryBg }}
                  className="w-[25px] flex items-center justify-center rounded-[6px] h-[25px] border"
                >
